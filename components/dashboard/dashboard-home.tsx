      ...
      <main className="mx-auto w-full max-w-[1300px] px-6 py-10">
        ...
        <section className="mt-10 grid gap-0 overflow-hidden rounded-[4px] border border-[#ece9df] lg:grid-cols-2">
          <div className="flex flex-col justify-between bg-white p-10 lg:border-r lg:border-[#ece9df]">
            <div className="max-w-[340px]">
              ...
              <p className="mt-4 text-[1.05rem] leading-7 text-[#4b4b4b]">
                Iterate on video generations with editing tools built for tighter creative control.
              </p>
            </div>
          ...
          <div className="relative aspect-[1.5/1] overflow-hidden lg:aspect-auto">
            <Image src={carsImage} alt="VideoGen" fill className="object-cover" />
          </div>
          ...
          {/* Floating Control */}
          <div className="absolute left-1/2 top-[calc(100%/1.4)] -translate-x-1/2 -translate-y-1/2 hidden lg:flex items-center gap-2 rounded-full bg-[#1a1a1a] p-1 shadow-xl">
             <div className="flex items-center gap-3 px-4 py-2">
                <Layout className="size-4 text-white" />
                <span className="text-sm font-medium text-white">Untitled</span>
                <ChevronDown className="size-3 text-white/50" />
             </div>
             <div className="h-6 w-px bg-white/20" />
             <div className="flex gap-1 px-2">
                {[1,2,3,4].map(i => <div key={i} className="size-2 rounded-full bg-white/10" />)}
             </div>
             <div className="h-6 w-px bg-white/20" />
             <div className="p-2">
        ...
        <section className="mt-20">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <WorkspaceCard type="project" title="Untitled" assets="0 assets" />
          </div>
        </section>
        ...
        <div className="flex items-center gap-4 py-3">
           <div className="flex h-11 w-full max-w-[800px] items-center rounded-full border border-[#ece9df] bg-[#fbfbfb] px-4">
              ...
              <div className="flex items-center gap-3 pl-4">
                <Music className="size-4 text-[#999]" />
      ...
      <div className="mx-auto w-full max-w-[1300px]">
        <div className="grid gap-12 lg:grid-cols-[1.1fr_2.4fr]">
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
             ...
             <FooterColumn title="Discover" links={["About ZOR", "Our Pricing & Plans", "Teams & Enterprise Plans", "Figma Templates", "Graphics", "Logos", "Website Templates", "AI Images", "Popular Searches"]} />
